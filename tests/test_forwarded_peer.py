...
from eugene_plexus_inference_driver import __main__ as entry
...
def entrypoint_kwargs(tmp_path: Path) -> dict[str, Any]:
    ...
    try:
        ...
        os.environ["EUGENE_PLEXUS_DRIVER_CONFIG_FILE"] = str(tmp_path / "config.yaml")
        os.environ["EUGENE_PLEXUS_DRIVER_BIND_PORT"] = "18999"
        entry.main()
    finally:
